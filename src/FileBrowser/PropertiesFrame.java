...
public class PropertiesFrame extends JDialog implements ActionListener {
    ...
    private void initWindow(String onoma) {
        ...
        // Se auto to kommati kwdika elegxoume 3exwrista gia ta tria checkBox an
        // mporoume
        // na diabasoume,na grapsoume h na ektelesoume to arxeio kai 8etoume antistoixa
        // isSelected(true/false).
        // Epipleon gia ka8e mia katastash tou arxeiou elegxoume an mporoume na to
        // alla3oume
        // sthn allh(px:readable->unreadable).An mporoume epanaferoume thn katastash toy
        // arxeiou
