...
public class ContentsScrollPane extends JScrollPane implements ActionListener {
    ...
    private void init(File currDirectory) {
        ...
        // MouseListener olwn twn arxeiwn pou kalei to popupMenu se periptwsh right
        // click
        // Afairei/pros8etei kai kanei enabled/disabled ta paste kai pasteInto
        // JMenuItems
    ...
    private void createFileicons(File[] filesList, JPanel contentPanel) {
        ...
        for (File f : filesList) {
            ...
            if (f.isDirectory()) {
                ...
                ImageIcon img = new ImageIcon(getClass().getClassLoader().getResource("folder.png"));
                ...
                if ((fileName.endsWith("audio")) || (fileName.endsWith("mp3")) ||
                    ...
                    img = new ImageIcon(getClass().getClassLoader().getResource("audio.png"));
