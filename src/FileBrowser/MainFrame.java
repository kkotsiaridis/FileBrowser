...
public class MainFrame extends JFrame {
    ...
    EditMenu editMenu; // created in: this.appInit and used in: MyMouseAdapter.createPopUpMenu for
                       // using EditMenu as ActionListener
    String path; // is updated from:(a)this.appInit (b)this.setCurrentPath
                 // (c)this.appContentsRefresh
    File currDirectory; // is updated from:(a)this.appInit (b)this.appContentsRefresh
    File currFileClicked; // is updated from:(a)MyMouseApapter.mouseClicked
                          // (b)ContentsScrollPane.actionPerformed
