...
import static ce326.hw3.MainFrame.NUMBER_OF_CHAR;
...
public class SearchPanel extends JPanel implements ActionListener,Runnable{
    ...
    private void init(){
        ...
        searchTextField = new JTextField(NUMBER_OF_CHAR);
    ...
    //o kurios anadromikos algori8mos pou trexei h anazhthsh kai vriskei ta arxeia pou periexoun to name
    //sto onoma tous.H anazhthsh 3ekinaei apo ton current Folder.Diatrexontas thn lista tou current Folder
    //elegxoume an einai arxeio h dir.An arxeio->elegxoume an periexei to name sto onoma.An dir->elegoume
    //an periexei to name sto onoma tou kai kaloume thn idia sunarthsh gia ayto to dir
    //Se ka8e epanalhpsh tou for an uparxoun nea apotelesmata au3anete o xoros tou pinaka kai enonontai ta apotelesmata
    ...
    //kalei thn searchForFiles,thn anadromikh sunarthsh tou search kai sthn sunexeia epe3ergazete ta 
    //apotelesmata auths gia na krathsei mono ta arxeia pou exoun thn apaitoumenh katalh3h
