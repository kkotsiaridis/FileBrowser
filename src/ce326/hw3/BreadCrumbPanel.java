 ...
 * @author Konstantinos
 */
//To panel pou periexei to breadCrumb,dhladh to absolute path tou current Directory
...
public class BreadCrumbPanel extends JPanel implements ActionListener{
    ...
    //Xrhsimopoiontas ta n-1 paths pou prokuptoun apo thn pathDivider ftiaxnoume kai 
    //pros8etoume ta Jbuttons tou breadcrumb(o fakelos pou eimaste den einai Jbutton,mono Jlabel)
    private void createBreadCrumbIcons(String[] paths){
        ...
        //kai to orizoyme ws onoma tou koumpiou,enw vazoume ws entolh tou oloklhro to path
        i=0;
        for(String s :paths){
            if(s == null){
                continue;
    ...
    //2)ta periexomena tou BreadcrumbPanel kai enhmerwnontai me to currentPath=HomeFolder
